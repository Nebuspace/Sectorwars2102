...
const PARITY_SOURCES: Record<string, LandedVistaSource> = {
  ...
  TROPICAL:    { seedKey: 'parity-TROPICAL-001',    planetType: 'TROPICAL',    habitability: 74, citadelLevel: 2, orbitAu: 0.95, star: { kind: 'G_YELLOW', color: '#fff4d0' }, moons: 0 },
  ...
  JUNGLE:      { seedKey: 'parity-JUNGLE-001',      planetType: 'JUNGLE',      habitability: 78, citadelLevel: 3, orbitAu: 0.9,  star: { kind: 'G_YELLOW', color: '#fff4d0' }, moons: 1 },
