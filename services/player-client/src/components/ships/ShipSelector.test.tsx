...
describe('ShipSelector — FLEET location-gate', () => {
  ...
  it('formatShipSelectorError falls back on TypeError network collapse (LEG-3316)', () => {
  ...
  it('formatShipSelectorError falls back on axios Network Error / Failed to fetch (LEG-3316)', () => {
  ...
  it('change-ship TypeError surfaces fallback without Failed to fetch / TypeError in DOM (LEG-3316)', async () => {
