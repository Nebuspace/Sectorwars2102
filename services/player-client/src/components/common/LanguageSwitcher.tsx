...
/** Canon-aligned offline completion (sw2102-docs OPERATIONS/i18n.md §1). */
...
const STATIC_ACTIVE_LOCALES = new Set(['en', 'es', 'fr', 'zh', 'pt', 'de']);

function buildStaticLanguages(): Language[] {
