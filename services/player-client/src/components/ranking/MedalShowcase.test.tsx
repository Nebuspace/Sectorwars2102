 ...
 * + LEG-91 hydrate pin from GET /medals/me.pinned_medal_id.
 *
...
describe('MedalShowcase', () => {
  ...
  it('hydrates pinned medal from getMe on first paint (LEG-91)', async () => {
    mockGetMedals.mockResolvedValue({
      earned: [makeMedal({ key: 'star_bronze' })],
      available: [],
    ...
    expect(container.querySelector('[data-testid="medal-clear-pin"]')).toBeTruthy();
  });
