 ...
 *
 * LEG-2482: quantum shards/crystals live on `quantumStatus` (same inventory
 ...
 * pointing at the existing SpaceDock Refining Facility — hint copy only; do
 * not duplicate CrystalRefiningPanel / refine POST here. HOLD tank math stays
 * on ship.cargo used/capacity only — no invented occupancy.
 */
...
/** Canon conversion ratio — refine POST stays on RefiningVenue. */
const QUANTUM_REFINE_HINT =
  'Refine: 5 quantum shards → 1 quantum crystal — SpaceDock Refining Facility';
const QUANTUM_REFINE_HINT_ID = 'mfd-cargo-quantum-refine-hint';
              ...
              <ul className="mfd-page-cargo-list">
                ...
                {quantumLines.map(([resource, qty]) => (
                  <li
                    ...
                    aria-describedby={QUANTUM_REFINE_HINT_ID}
                  >
                    <span className="mfd-page-cargo-name">
                      <span
                        className="mfd-cargo-swatch"
