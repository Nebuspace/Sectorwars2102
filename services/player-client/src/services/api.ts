...
export const shipUpgradeAPI = {
  ...
  // Equipment-slot install/uninstall (LEG-109 / LEG-115). Still live for
  // equipment_slots keys (mining_laser, quantum_harvester, …). Distinct from
  // module-grid installModule/removeModule below — the deferred lattice
  // `mining` / `harvester` families stay out of this path.
