          ...
          <div className="stats-grid">
            ...
            <Link to="/universe/stations" className="stat-card clickable-stat-card">
              ...
              <div className="stat-value">
                {galaxyState.statistics.station_count != null
                  ? galaxyState.statistics.station_count
                  : '—'}
              </div>
              <div className="stat-detail">
                {galaxyState.statistics.station_count != null && galaxyState.statistics.total_sectors > 0
            ...
            <Link to="/universe/planets" className="stat-card clickable-stat-card">
              ...
              <h3>Planets</h3>
              <div className="stat-value">
                {galaxyState.statistics.planet_count != null
                  ? galaxyState.statistics.planet_count
                  : '—'}
              </div>
              <div className="stat-detail">
                {galaxyState.statistics.planet_count != null && galaxyState.statistics.total_sectors > 0
