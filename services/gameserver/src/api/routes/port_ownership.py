...
async def withdraw_treasury(
    ...
    """Withdraw credits from the station treasury (solo owner, or team
    LEADER|OFFICER with member-share split; canon caps every withdrawal
    at 90% of the current balance so a 10% operating cushion remains)."""
    station = _get_station_or_404(db, station_id)
    try:
