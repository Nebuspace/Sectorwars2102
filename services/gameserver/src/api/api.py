...
from src.api.routes.player_trade import router as player_trade_router
...
from src.api.routes.station_stake_transfer import router as station_stake_transfer_router
...
api_router.include_router(player_trade_router, tags=["player-trade"])  # ADR-0089 P2P trade (prefix /trade)
...
api_router.include_router(station_stake_transfer_router, tags=["port-ownership"])
...
api_router.include_router(syndicate_fence_router, tags=["syndicate-fence"])
...
api_router.include_router(pending_engagements_router, tags=["pending-engagements"])  # LEG-480
