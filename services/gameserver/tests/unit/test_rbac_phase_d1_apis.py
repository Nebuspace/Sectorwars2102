...
class TestScopeCatalogDescriptions:
    def test_catalog_covers_all_26_scopes_with_nonempty_descriptions(self):
        assert len(SCOPE_DESCRIPTIONS) == 26
    ...
    def test_catalog_route_returns_scope_catalog_items(self):
        ...
        assert "26-scope catalog" in _ADMIN_SCOPES_SRC
        assert "19-scope" not in _ADMIN_SCOPES_SRC
