...
async def test_get_team_messages_unexpected_is_opaque_500():
    ...
    exc = excinfo.value
    assert exc.status_code == 500
    assert exc.detail == "Failed to load team messages"
    assert secret not in str(exc.detail)
...
async def test_mark_message_read_unexpected_is_opaque_500():
    ...
    exc = excinfo.value
    assert exc.status_code == 500
    assert exc.detail == "Failed to mark message as read"
    assert secret not in str(exc.detail)
...
async def test_delete_message_unexpected_is_opaque_500():
    ...
    exc = excinfo.value
    assert exc.status_code == 500
    assert exc.detail == "Failed to delete message"
    assert secret not in str(exc.detail)
...
async def test_get_conversations_unexpected_is_opaque_500():
    ...
    exc = excinfo.value
    assert exc.status_code == 500
    assert exc.detail == "Failed to load conversations"
    assert secret not in str(exc.detail)
...
async def test_flag_message_unexpected_is_opaque_500():
    ...
    exc = excinfo.value
    assert exc.status_code == 500
    assert exc.detail == "Failed to flag message"
    assert secret not in str(exc.detail)
